...
{
    Task<IReadOnlyList<EventDto>> GetLatestEventsAsync(int skip = 0, int take = 10, string? searching = null, IReadOnlyCollection<int>? categoryIds = null, string? sortBy = null, bool onlyUpcoming = false);
